...
@php
    // هویت بصری اصلی برند — عیناً همان طرحی که کارفرما طراحی و ارسال کرده
    // است. تغییر داده نمی‌شود؛ فقط رنگ بدنه بر اساس روشن/تیره بودن پس‌زمینه
    // عوض می‌شود تا روی هر دو زمینه خوانا بماند.
