...
<div class="flex min-h-screen" x-data="{ sidebar: false }">
    ...
    <aside class="fixed inset-y-0 right-0 z-40 w-64 -translate-x-0 overflow-y-auto bg-navy-900 transition-transform lg:static lg:translate-x-0"
        ...
        <div class="flex h-16 items-center gap-2.5 px-5">
            <x-logo variant="light" class="h-8" />
        ...
        <nav class="space-y-6 p-3">
            @php
                $groups = [
                    ...
                    'محتوا و تنظیمات' => [
                        ['admin.coupons.index', 'کدهای تخفیف', 'M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m0 0a2.25 2.25 0 0 1-2.276 2.022H8.625'],
